...
std::list<std::unique_ptr<AmmoROFLE>> AmmoROFLE::activeParticles_;

AmmoROFLE::AmmoROFLE(Vector2f const & location, Vector2f const & direction,
...
AmmoROFLE::~AmmoROFLE() { trailEffects::detach(this); }
