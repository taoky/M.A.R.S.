...
AmmoShotgun::AmmoShotgun(Vector2f const & location, Vector2f const & direction,
                         ...
                         Player * damageSource)
    : Particle<AmmoShotgun>(spaceObjects::oAmmoShotgun, location, 2.5f, 0.5f,
                            randomizer::random(0.3f, 0.7f)),
      color_(1.f, 0.7f, 0.2f)
{
    ...
    trailEffects::attach(this, 0.02f, 0.1f, 4.f, Color3f(0.3f, 0.2f, 0.05f),
                         false);
}

AmmoShotgun::~AmmoShotgun() { trailEffects::detach(this); }
