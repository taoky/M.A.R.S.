           ...
           Color3f const & color, Player * damageSource)
{
    ...
    {
    case pAmmoAFK47:
        AmmoAFK47::spawn(location, direction, velocity, color, damageSource);
        break;
    case pAmmoBurner:
        AmmoBurner::spawn(location, direction, velocity, color, damageSource);
        break;
    case pAmmoFlubba:
        AmmoFlubba::spawn(location, direction, velocity, color, damageSource);
        break;
    case pFuel:
        Fuel::spawn(location, direction, velocity, color, damageSource);
        break;
    case pMud:
        Mud::spawn(location, direction, velocity, color, damageSource);
        break;
    case pSmoke:
        Smoke::spawn(location, direction, velocity, color, damageSource);
        break;
    case pEruption:
        Eruption::spawn(location, direction, velocity, color, damageSource);
        break;
    case pAmmoROFLE:
        AmmoROFLE::spawn(location, direction, velocity, color, damageSource);
        break;
    case pAmmoShotgun:
        AmmoShotgun::spawn(location, direction, velocity, color, damageSource);
        break;
    case pDust:
        Dust::spawn(location, direction, velocity, color, damageSource);
        break;
    case pExplode:
        Explode::spawn(location, direction, velocity, color, damageSource);
        break;
    case pBurningFragment:
        BurningFragment::spawn(location, direction, velocity, color,
                               damageSource);
        break;
    case pFragmentFlame:
        FragmentFlame::spawn(location, direction, velocity, color,
                             damageSource);
        break;
    case pMiniFlame:
        MiniFlame::spawn(location, direction, velocity, color, damageSource);
        break;
    case pMiniAmmoFlubba:
        MiniAmmoFlubba::spawn(location, direction, velocity, color,
                              damageSource);
        break;
    case pCannonBall:
        CannonBall::spawn(location, direction, velocity, color, damageSource);
        break;
    case pSpark:
        Spark::spawn(location, direction, velocity, color, damageSource);
        break;
    case pFragment:
        Fragment::spawn(location, direction, velocity, color, damageSource);
        break;
    case pAmmoH2OMG:
        AmmoH2OMG::spawn(location, direction, velocity, color, damageSource);
        break;
    case pHeat:
        Heat::spawn(location, direction, velocity, color, damageSource);
        break;
    case pHeatJet:
        HeatJet::spawn(location, direction, velocity, color, damageSource);
        break;
    case pShockWave:
        ShockWave::spawn(location, direction, velocity, color, damageSource);
        break;
    case pHeatBurner:
        HeatBurner::spawn(location, direction, velocity, color, damageSource);
        break;
    case pMiniFlameSmoke:
        MiniFlameSmoke::spawn(location, direction, velocity, color,
                              damageSource);
        break;
    case pAmmoRocket:
        AmmoRocket::spawn(location, direction, velocity, color, damageSource);
        break;
    case pPowerUpCollect:
        PowerUpCollect::spawn(location, direction, velocity, color,
                              damageSource);
        break;
    case pAmmoFist:
        AmmoFist::spawn(location, direction, velocity, color, damageSource);
        break;
    case pNumber:
        Number::spawn(location, direction, velocity, color, damageSource);
        break;
    case pCrushedIce:
        CrushedIce::spawn(location, direction, velocity, color, damageSource);
        break;
    case pAmmoInsta:
        AmmoInsta::spawn(location, direction, velocity, color, damageSource);
        break;
    case pStar:
        Star::spawn(location, direction, velocity, color, damageSource);
        break;
    }
}
...
{
    for (int i = 0;
         i <= (amount * settings::C_globalParticleCount) * timer::frameTime();
         ++i)
        spawn(type, location, direction, velocity, color, damageSource);
}
...
int count()
{
    return trailEffects::count() + Fuel::count() + Mud::count() +
           ...
           AmmoROFLE::count() + Dust::count() + Explode::count() +
           BurningFragment::count() + FragmentFlame::count() +
           AmmoShotgun::count() + MiniFlame::count() + AmmoFlubba::count() +
           MiniAmmoFlubba::count() + CannonBall::count() + Spark::count() +
           Fragment::count() + AmmoBurner::count() + AmmoH2OMG::count() +
           Heat::count() + HeatJet::count() + ShockWave::count() +
           HeatBurner::count() + MiniFlameSmoke::count() + AmmoRocket::count() +
           PowerUpCollect::count() + AmmoFist::count() + Number::count() +
           CrushedIce::count() + AmmoInsta::count() + Star::count();
}
