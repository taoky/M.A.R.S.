...
std::list<std::shared_ptr<ShockWave>> ShockWave::activeParticles_;

ShockWave::ShockWave(Vector2f const & location, Vector2f const & direction,
                     Vector2f const & velocity, Color3f const & color,
                     Player * damageSource)
    : Particle<ShockWave>(spaceObjects::oShockWave, location, 4, 0,
                          randomizer::random(0.6f, 1.f))
{
}
