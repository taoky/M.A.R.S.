...
int main(int argc, char * argv[])
{
    ...
    for (int i = 1; i < argc; ++i)
    {
            ...
            std::string(argv[i]) == "--help")
        {
            ...
            std::cout << "    -cfg  <Path>     Sets the absolute path to the "
                         "configuration directory of the game."
                      << std::endl;
            std::cout << "    -data <Path>     Sets the absolute path to the "
                         "data directory of the game,"
                      << std::endl;
            std::cout << "                     which contains the folders "
                         "sound/, tex/ and so on."
                      << std::endl;
            std::cout << std::endl;
            std::cout << "Miscellaneous Options:" << std::endl;
            std::cout << "    -help            Print program options."
                      << std::endl;
        ...
        {
            std::cout
                << "M.A.R.S. - a ridiculous shooter " << VERSION_MAJOR << "."
        ...
        else if (std::string(argv[i]) == "-cfg")
        {
            if (++i < argc)
                ...
                std::cout << "Option \"-cfg\" expects a path to be provided "
                             "following it.\n";
        }
        else if (std::string(argv[i]) == "-data")
        {
            if (++i < argc)
                ...
                std::cout << "Option \"-data\" expects a path to be provided "
                             "following it.\n";
        }
        else
        {
            std::cout
                ...
                << "\". Use -help for a complete list of supported flags.\n";
        }
    }
