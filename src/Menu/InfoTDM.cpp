...
auto InfoTDM::get() -> UiWindow *
{
    if (instance_ == nullptr)
    {
        ...
        instance_->addWidget(new Button(locales::getLocale(locales::Close),
                                        ...
                                        90, 20));
        instance_->addWidget(new Label(new sf::String("Team-DeathMatch"),
        ...
        instance_->addWidget(
            new TextBox(locales::getLocale(locales::ShortDescriptionTDM),
        ...
        instance_->addWidget(
            new Checkbox(locales::getLocale(locales::ShowAgainButton), nullptr,
                         &settings::C_showInfoTDM, Vector2f(10, 270), 170));
    }
    return instance_;
}
...
void InfoTDM::onShow() { settings::C_showInfoTDM = false; }
