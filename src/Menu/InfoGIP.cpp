...
UiWindow * InfoGIP::instance_(nullptr);
bool InfoGIP::kClose_(false);

auto InfoGIP::get() -> UiWindow *
{
    if (instance_ == nullptr)
    {
        ...
        instance_->addWidget(
            new TextBox(locales::getLocale(locales::ShortDescriptionGIP),
...
void InfoGIP::onShow() { settings::C_showInfoDM = false; }
