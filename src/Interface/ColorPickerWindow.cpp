...
void ColorPickerWindow::draw() const
{
    ...
    if (sf::Mouse::isButtonPressed(sf::Mouse::Left) && x > origin.x_ &&
        x < origin.x_ + 190 && y > origin.y_ && y < origin.y_ + 150)
    {
        if (x > origin.x_ + 140)
        {
    ...
    glColor3f(1.f, 1.f, 1.f);
    glBegin(GL_QUADS);
    glTexCoord2f(0.234375f, 0.390625f);
    glVertex2f(origin.x_ + 150.f, origin.y_ + 10.f);
    glTexCoord2f(0.234375f, 0.625f);
    glVertex2f(origin.x_ + 150.f, origin.y_ + 130.f);
    glTexCoord2f(0.29296875f, 0.625f);
    glVertex2f(origin.x_ + 180.f, origin.y_ + 130.f);
    glTexCoord2f(0.29296875f, 0.390625f);
    glVertex2f(origin.x_ + 180.f, origin.y_ + 10.f);
    glEnd();
    ...
    tmp.v(1.f - val);
    tmp.gl3f();
    Vector2f pickerLocation(origin +
                            Vector2f(10.f + val * 120.f, 130.f - sat * 120.f));
    glBegin(GL_QUADS);
    glTexCoord2f(0.8359375f, 0.06640625f);
    glVertex2f(pickerLocation.x_ + 8.f, pickerLocation.y_ + 8.f);
    glTexCoord2f(0.8359375f, 0.09765625f);
    glVertex2f(pickerLocation.x_ + 8.f, pickerLocation.y_ - 8.f);
    glTexCoord2f(0.8671875f, 0.09765625f);
    glVertex2f(pickerLocation.x_ - 8.f, pickerLocation.y_ - 8.f);
    glTexCoord2f(0.8671875f, 0.06640625f);
    glVertex2f(pickerLocation.x_ - 8.f, pickerLocation.y_ + 8.f);
    glEnd();
