    ...
    : UiElement(topLeft, width, height), key_(key), toolTip_(toolTip)
{
    ...
    case TEXT_ALIGN_LEFT:
        label_ = new Label(text, align, Vector2f(4, 2), 12.f,
                           Color3f(0.75f, 0.75f, 0.75f), true, font);
        break;
    case TEXT_ALIGN_RIGHT:
        label_ = new Label(text, align, Vector2f(width - 4, 2), 12.f,
                           Color3f(0.75f, 0.75f, 0.75f), true, font);
        break;
    default:
        label_ = new Label(text, align, Vector2f(width * 0.5f, 2), 12.f,
                           Color3f(0.75f, 0.75f, 0.75f), true, font);
    }
