...
Vector2f::Vector2f(Vector2f const & point) : x_(point.x_), y_(point.y_) {}
...
float Vector2f::lengthSquare() const { return x_ * x_ + y_ * y_; }
...
Vector2f operator*(float const & lhs, Vector2f rhs) { return rhs * lhs; }
