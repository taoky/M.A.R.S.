...
Planet::Planet(Vector2f const & location, float radius)
    : SpaceObject(spaceObjects::oPlanet, location, radius, radius * 100),
      texture_(texture::randomPlanet()), color_(texture::getMudColor(texture_))
{
                         ...
                         Vector2f const & direction, Vector2f const & velocity)
{
    ...
    case spaceObjects::oAmmoInsta:
        particles::spawnMultiple(20, particles::pMud, location,
                                 location - location_, velocity, color_);
        break;

    case spaceObjects::oAmmoShotgun:
        particles::spawnMultiple(2, particles::pMud, location,
                                 location - location_, velocity, color_);
        break;
    ...
    case spaceObjects::oShip:
        if (strength > 50)
            particles::spawnMultiple(10, particles::pMud, location,
                                     location - location_, velocity, color_);
        break;
