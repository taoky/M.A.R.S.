...
void GamePoints::draw() const
{
    ...
    if (timer_ > 0.f)
    {
        ...
        else
        {
            ...
            particles::spawnTimed(20, particles::pDust,
                                  Vector2f(SPACE_X_RESOLUTION * 0.5f, 820));
        }
        ...
        glTexCoord2f(0.78125f, 0.f);
        glVertex2f(midPoint - 31.f, viewPort.y_ - 35.f - top);
        glTexCoord2f(0.78125f, 0.09765625f);
        glVertex2f(midPoint - 31.f, viewPort.y_ - top + 15.f);
        glTexCoord2f(0.8203125f, 0.09765625f);
        glVertex2f(midPoint - 11.f, viewPort.y_ - top + 15.f);
        glTexCoord2f(0.8203125f, 0.f);
        glVertex2f(midPoint - 11.f, viewPort.y_ - 35.f - top);
        ...
        sstr << teams::getTeamL()->victories() << " : "
             << teams::getTeamR()->victories();
        text::drawFooText();
        text::drawScreenText(sf::String(sstr.str()),
                             Vector2f(midPoint, viewPort.y_ - 60.f - top), 20.f,
