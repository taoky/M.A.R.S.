...
void RightLife::draw() const
{
    ...
    if (player)
    {
        ...
        text::drawScreenText(sf::String(sstr.str()),
                             Vector2f(port.x_ - 9.f, port.y_ - 74.f), 18.f,
                             TEXT_ALIGN_RIGHT, Color3f(0.f, 0.f, 0.f));
        text::drawScreenText(sf::String(sstr.str()),
                             Vector2f(port.x_ - 10.f, port.y_ - 75.f), 18.f,
                             TEXT_ALIGN_RIGHT, color);
        ...
        glTexCoord2f(0, 0);
        glVertex2f(port.x_, port.y_ - 64);
        glTexCoord2f(0, 1);
        glVertex2f(port.x_, port.y_);
        glTexCoord2f(0.75f, 1);
        glVertex2f(port.x_ - 192, port.y_);
        glTexCoord2f(0.75f, 0);
        glVertex2f(port.x_ - 192, port.y_ - 64);
        glEnd();
