...
void inline writeScoreAtCol(sf::String value, int col, Vector2f topLeft,
                            int mirror, Color3f drawColor)
{
    text::drawScreenText(value,
                         topLeft + Vector2f((140 + 80 * col + 1) * mirror, 1),
                         12.f, TEXT_ALIGN_CENTER, Color3f(0.f, 0.f, 0.f));
    text::drawScreenText(value,
                         topLeft + Vector2f((140 + 80 * col) * mirror, 0), 12.f,
                         TEXT_ALIGN_CENTER, drawColor);
}

void inline writeScoreAtCol(int value, int col, Vector2f topLeft, int mirror,
                            Color3f drawColor)
{
...
TabStats::TabStats() : visible_(false), refresh_(false), sumPoints_(0) {}
...
void TabStats::draw() const
{
    if (visible_ && !menus::visible())
    {
        ...
        // topleft
        glTexCoord2f(0, 0);
        glVertex2i(topLeft.x_ - 60 * mirror, topLeft.y_ - 60);
        glTexCoord2f(0, 96.f / 512.f);
        glVertex2i(topLeft.x_ - 60 * mirror, topLeft.y_ + 36);
        glTexCoord2f(96.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ + 36);
        glTexCoord2f(96.f / 512.f, 0);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ - 60);
        // topRight
        glTexCoord2f(96.f / 512.f, 0);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ - 60);
        glTexCoord2f(96.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ + 36);
        glTexCoord2f(96.f / 256.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ + 60 * mirror + width, topLeft.y_ + 36);
        glTexCoord2f(96.f / 256.f, 0);
        glVertex2i(topLeft.x_ + 60 * mirror + width, topLeft.y_ - 60);
        // bottomleft
        glTexCoord2f(0, 96.f / 512.f);
        glVertex2i(topLeft.x_ - 60 * mirror, topLeft.y_ - 36 + height);
        glTexCoord2f(0, 96.f / 256.f);
        glVertex2i(topLeft.x_ - 60 * mirror, topLeft.y_ + 60 + height);
        glTexCoord2f(96.f / 512.f, 96.f / 256.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ + 60 + height);
        glTexCoord2f(96.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ - 36 + height);
        // bottomRight
        glTexCoord2f(96.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ - 36 + height);
        glTexCoord2f(96.f / 512.f, 96.f / 256.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ + 60 + height);
        glTexCoord2f(96.f / 256.f, 96.f / 256.f);
        glVertex2i(topLeft.x_ + 60 * mirror + width, topLeft.y_ + 60 + height);
        glTexCoord2f(96.f / 256.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ + 60 * mirror + width, topLeft.y_ - 36 + height);

        // top
        glTexCoord2f(193.f / 512.f, 0);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ - 60);
        glTexCoord2f(193.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ + 36);
        glTexCoord2f(199.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ + 36);
        glTexCoord2f(199.f / 512.f, 0);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ - 60);
        // right
        glTexCoord2f(96.f / 512.f, 193.f / 512.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ + 36);
        glTexCoord2f(96.f / 512.f, 199.f / 512.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ - 36 + height);
        glTexCoord2f(96.f / 256.f, 199.f / 512.f);
        glVertex2i(topLeft.x_ + 60 * mirror + width, topLeft.y_ - 36 + height);
        glTexCoord2f(96.f / 256.f, 193.f / 512.f);
        glVertex2i(topLeft.x_ + 60 * mirror + width, topLeft.y_ + 36);
        // left
        glTexCoord2f(0, 193.f / 512.f);
        glVertex2i(topLeft.x_ - 60 * mirror, topLeft.y_ + 36);
        glTexCoord2f(0, 199.f / 512.f);
        glVertex2i(topLeft.x_ - 60 * mirror, topLeft.y_ - 36 + height);
        glTexCoord2f(96.f / 512.f, 199.f / 512.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ - 36 + height);
        glTexCoord2f(96.f / 512.f, 193.f / 512.f);
        ...
        glTexCoord2f(193.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ - 36 + height);
        glTexCoord2f(193.f / 512.f, 96.f / 256.f);
        glVertex2i(topLeft.x_ + 36 * mirror, topLeft.y_ + 60 + height);
        glTexCoord2f(199.f / 512.f, 96.f / 256.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ + 60 + height);
        glTexCoord2f(199.f / 512.f, 96.f / 512.f);
        glVertex2i(topLeft.x_ - 36 * mirror + width, topLeft.y_ - 36 + height);
        glEnd();
        ...
        text::drawFooText();
        text::drawScreenText(*locales::getLocale(locales::Statistics),
                             topLeft + Vector2f(10 * mirror, 10), 20.f,
                             TEXT_ALIGN_LEFT, Color3f(1.f, 0.5f, 0.8f));
        std::stringstream sstr;
        int seconds = games::elapsedTime();
        sstr << std::setfill('0') << std::setw(2)
             << (seconds - seconds % 60) / 60 << " : " << std::setw(2)
             << seconds % 60;
        text::drawScreenText(sf::String(sstr.str()),
                             topLeft + Vector2f(width - 10 * mirror, 18), 12.f,
                             TEXT_ALIGN_RIGHT, Color3f(1.f, 0.5f, 0.8f));
        ...
        sstr.str("");
        sstr << ": " << pointlimit;
        text::drawScreenText(name + sf::String(sstr.str()),
                             topLeft + Vector2f(width * 0.5f, 18), 12.f,
                             TEXT_ALIGN_CENTER, Color3f(1.f, 0.5f, 0.8f));
        ...
        text::drawScreenText(*locales::getLocale(locales::Points),
                             topLeft + Vector2f((140 + 80 * col++) * mirror, 0),
                             12.f, TEXT_ALIGN_CENTER,
                             Color3f(0.7f, 0.7f, 0.7f));
        if (games::type() == games::gCannonKeep)
            text::drawScreenText(
                *locales::getLocale(locales::CannonShots),
                topLeft + Vector2f((140 + 80 * col++) * mirror, 0), 12.f,
                TEXT_ALIGN_CENTER, Color3f(0.7f, 0.7f, 0.7f));
        if (games::type() == games::gSpaceBall)
            text::drawScreenText(
                *locales::getLocale(locales::SpaceBallGoals),
                topLeft + Vector2f((140 + 80 * col++) * mirror, 0), 12.f,
                TEXT_ALIGN_CENTER, Color3f(0.7f, 0.7f, 0.7f));
        text::drawScreenText(*locales::getLocale(locales::Frags),
                             topLeft + Vector2f((140 + 80 * col++) * mirror, 0),
                             12.f, TEXT_ALIGN_CENTER,
                             Color3f(0.7f, 0.7f, 0.7f));
        if (games::type() != games::gDeathMatch &&
            games::type() != games::gRally)
            text::drawScreenText(
                *locales::getLocale(locales::TeamKills),
                topLeft + Vector2f((140 + 80 * col++) * mirror, 0), 12.f,
                TEXT_ALIGN_CENTER, Color3f(0.7f, 0.7f, 0.7f));
        text::drawScreenText(*locales::getLocale(locales::Suicides),
                             topLeft + Vector2f((140 + 80 * col++) * mirror, 0),
                             12.f, TEXT_ALIGN_CENTER,
                             Color3f(0.7f, 0.7f, 0.7f));
        text::drawScreenText(*locales::getLocale(locales::Deaths),
                             topLeft + Vector2f((140 + 80 * col++) * mirror, 0),
                             12.f, TEXT_ALIGN_CENTER,
                             Color3f(0.7f, 0.7f, 0.7f));
        ...
        for (const auto & it : teamMap_)
        {
            ...
            for (auto member : members)
            {
                    ...
                    member->controlType_ != controllers::cPlayer2)
                {
                    text::drawScreenText(
                        ...
                        12.f, TEXT_ALIGN_LEFT, Color3f(0.f, 0.f, 0.f));
                    text::drawScreenText(sf::String("[BOT]"),
                                         topLeft + Vector2f(80 * mirror, 0),
                                         12.f, TEXT_ALIGN_LEFT, drawColor);
                }
                col = 0;
                // draw points
                ...
                games::type() != games::gRally)
            {
                ...
                if (games::type() == games::gCannonKeep)
                {
                    if (totalCannonShots > 0)
                        drawColor = Color3f(0.3, 1, 0.3);
                    else
                        drawColor = Color3f(1, 1, 0.3);
                    writeScoreAtCol(totalCannonShots, col++, topLeft, mirror,
                                    drawColor);
                }
                else if (games::type() == games::gSpaceBall)
                {
                ...
                if (totalTeamKills > 0)
                    ...
                    drawColor = Color3f(0.3, 1, 0.3);
                writeScoreAtCol(totalTeamKills, col++, topLeft, mirror,
                                drawColor);
                ...
                if (totalSuicides > 0)
                    ...
                    drawColor = Color3f(0.3, 1, 0.3);
                writeScoreAtCol(totalSuicides, col++, topLeft, mirror,
                                drawColor);
...
void TabStats::display(bool show) { visible_ = show; }
